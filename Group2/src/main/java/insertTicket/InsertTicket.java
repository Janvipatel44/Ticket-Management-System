...
public class InsertTicket implements IInsertTicket {
	...
	IParameterizedTicket createTicket;
	IUserInputValidation userinput = new UserInputValidation();
	...
	public boolean userInputTicketDetails() throws ParseException 
	{
		    ...
		    createTicket = new ParameterizedTicket(ticketID, description, expectedEndDate, reporterID, employeeID, 
		    		assigneeName, ticketType, ticketStatus,priority, urgency, impact, 
