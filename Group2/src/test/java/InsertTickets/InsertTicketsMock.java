 ...
 * java.util.List; import Tickets.CreateTicket; import Tickets.ICreateTicket;
 * import validations.IInputDateValidation; import
 * validations.IInputRangeValidation; import validations.IInputStringValidation;
 * import validations.InputDateValidationMock; import
 * validations.InputRangeValidationMock; import
 * validations.InputStringValidationMock; import database.ITicketOperationsDB;
 * import database.TicketOperationsDB;
 * 
 * public class InsertTicketsMock { ITicketOperationsDB ticketOperationDB =
 * null; IInputStringValidation ticketStringValidation = new
 * InputStringValidationMock(); IInputDateValidation dateValidation = new
 * InputDateValidationMock(); IInputRangeValidation rangeValidation = new
 * InputRangeValidationMock(); ICreateTicket createTicket = new CreateTicket();
 * 
 * public boolean validateInsertion(ICreateTicket createTicket) throws
 * ParseException {
 * 
 ...
 * 
 * return false; } } System.out.print("At Last"); return true; } public void
 * successfulInsertion(ICreateTicket createTicket) { boolean result = false;
 * 
 * try {
 * 
 * ticketOperationDB = new TicketOperationsDB(createTicket); result =
 * ticketOperationDB.duplicateTicket(); if(result==false) { result =
 * ticketOperationDB.insertTicket(); System.out.print(result); } } catch
 * (NumberFormatException e) { // TODO Auto-generated catch block
 * System.out.print("Hello"); e.printStackTrace(); } } }
 */