...
public class RegistrationTest
{
	...
	@Mock
	private IDatabaseUserRegistrationOperations databaseUserRegistrationOperations = new DatabaseUserRegistrationOperations(connection);
	...
	{		
		...
		@InjectMocks IRegister registration = new Registration(databaseUserRegistrationOperations, inputOutputHandler, encryption);
